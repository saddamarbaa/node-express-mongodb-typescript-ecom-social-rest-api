...
const { SEND_GRID_API_KEY, ADMIN_SEND_GRID_EMAIL, CLIENT_URL } = require('../configs/environment.config');
...
exports.sendResetPasswordEmail = (userEmail, userName, link) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
exports.sendConfirmResetPasswordEmail = (userEmail, userName, link) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
exports.sendEmailVerificationEmail = (userEmail, userName, link) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
